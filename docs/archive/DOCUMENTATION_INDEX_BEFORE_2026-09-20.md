...
- [Logging policy, public-report audit and production crash-memory privacy fix](../current/LOGGING_PRIVACY_REVIEW_2026-09-20.md).

- [Automatic layout: freshness, reconnection and manual selection regression review](../current/AUTOMATIC_LAYOUT_REVIEW_2026-09-20.md).

- [Profile persistence: save/load, failure recovery and interrupted-write restart checks](../current/PROFILE_PERSISTENCE_REVIEW_2026-09-20.md).

- [Input lifecycle: Pause/failed-Resume ordering fix and Block Bound Keys review](../current/INPUT_LIFECYCLE_REVIEW_2026-09-20.md).

> 2026-09-20: ATTACK SHARK family work is paused by owner until a tester is available. Existing support and research are preserved; see [current audit](../current/ATTACK_SHARK_BANK_INIT_2026-09-20.md).

- [ATTACK SHARK: switch-to-bank mapping, X82 application decompression and normalization limits](../current/ATTACK_SHARK_BANK_INIT_2026-09-20.md).

- [ATTACK SHARK depth range: firmware lookup evidence and unresolved per-bank scaling](../current/ATTACK_SHARK_DEPTH_RANGE_2026-09-20.md).

- [ATTACK SHARK family layouts: all37 exact selectors,16 visible groups, source discrepancies and verification](../current/ATTACK_SHARK_FAMILY_LAYOUTS_2026-09-20.md).

- [ATTACK SHARK: 37 exact RY5088 revisions enabled, native analog and testing notices](../current/ATTACK_SHARK_FAMILY_SUPPORT_2026-09-20.md).

- [ATTACK SHARK family: 37 exact revisions, three available firmware images and X68 MAX component proof](../research/ATTACK_SHARK_FAMILY_2026-09-20.md).

- [GravaStar V75 / Pro / Lite layouts and automatic remaps](../current/GRAVASTAR_LAYOUTS_2026-09-19.md).
- [X68 HE non-Pro firmware acquisition recheck](../research/ATTACK_SHARK_X68_HE_RECHECK_2026-09-19.md).

- [Layout/support inventory correction: GravaStar gaps and research-only branches](../current/LAYOUT_SUPPORT_GAPS_2026-09-19.md).

# HallJoy — навигация по документации

- [SayoDevice O3C: three physical keys, optional binding labels and firmware validation](../current/SAYO_O3C_CONFIG_2026-09-19.md).

> 2026-09-19: [K673 BR resolved](../current/REDRAGON_K673_BR_LAYOUT_2026-09-19.md): exact manufacturer ABNT2 image confirms a wide /? key, not Right Shift. ABNT2 preset and verified-product selection added; native analog unchanged. Earlier BR deferral is superseded.

- [Razer regional geometry, exact sources and deferred variants](../current/RAZER_REGIONAL_LAYOUTS_2026-09-19.md).

- [MG75 Pro native support and experimental notice](../current/MG75_PRO_INTEGRATION_2026-09-19.md).

- [MG75 Pro/V2 firmware and SparkLink SDK analysis](../current/MG75_PRO_V2_REVIEW_2026-09-19.md).

- [MG75 Max Fn fix and MG75 Pro protocol correction](../current/MG75_FN_REVIEW_2026-09-19.md).

- [HERO84 automatic layout, modifiers, Fn and layout/native-map audit](../current/HERO84_INTEGRATION_2026-09-19.md).

- [AULA HERO84 HE and KP-TE153 layouts; missing native apostrophe position](../current/AULA_ADDITIONAL_LAYOUTS_2026-09-19.md).

- [Build replacement lifecycle: keep the app running until final replacement](../current/BUILD_REPLACEMENT_LIFECYCLE_2026-09-19.md).

- [Complete layout catalog audit: duplicates, saved names, automatic selection and README](../current/LAYOUT_CATALOG_AUDIT_2026-09-19.md).
- [Built-in model/region table](../KEYBOARD_LAYOUTS.md).

- [Hidden Configuration controls, Wooting grouping and automatic build shutdown](../current/HIDDEN_CONTROLS_AND_WOOTING_MERGE_2026-09-19.md).

- [Wooting 60HE v2, split physical keys and UwU layouts](../current/WOOTING_EXTENDED_LAYOUTS_2026-09-19.md).

- [X65 Pro: full input-path review and focused playable diagnostic](../current/INPUT_PATH_DIAGNOSTIC_2026-09-19.md).

- [Four additional Razer ANSI layouts](../current/RAZER_FOUR_LAYOUTS_2026-09-19.md).

- [Production digital depth emulation removed](../current/DIGITAL_DEPTH_EMULATION_REMOVAL_2026-09-19.md).

- [HallJoy 1.5.3 published: artifact and release verification](../current/RELEASE_1.5.3_CANDIDATE_2026-09-19.md).

- [ATTACK SHARK Pro: 1.5.4 prerelease, visual layouts, automatic selection and analog Fn fix](../current/ATTACK_SHARK_PRO_DIAGNOSTIC_2026-09-19.md).
...
- [Старый SOURCE_AUDIT_V6](source-v6/SOURCE_AUDIT_V6.md): история,
