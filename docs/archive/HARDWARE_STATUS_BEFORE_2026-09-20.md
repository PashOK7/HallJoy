...
[persistent owner context](../current/OWNER_CONTEXT.md).
...
[implementation and evidence](../current/NA87_MINI60_STANDARD_SUPPORT_2026-09-19.md).
...
[the source comparison](../current/REMAINING_LAYOUTS_2026-09-14.md).
...
2026-09-14: [IPI physical layouts](../current/IPI_LAYOUTS_2026-09-14.md)
