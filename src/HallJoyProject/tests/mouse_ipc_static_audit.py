...
require(mouse, "InterlockedIncrement(&g_mouseIpc->heartbeat);", "publisher has an ABI-preserving commit heartbeat")
require(mouse, "coherent reader rejects an odd/inconsistent capture", "multi-scalar capture policy is explicit")
require(header, "kHallJoyMouseIpcStructSize = 40", "v1 mapping ABI size is fixed")
require(header, "making this odd", "v1 heartbeat documents coherent capture semantics")
