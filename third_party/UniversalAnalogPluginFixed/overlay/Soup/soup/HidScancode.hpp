...
NAMESPACE_SOUP
{
	...
	*/
	...
	[[nodiscard]] constexpr Key hid_scancode_to_soup_key(uint8_t scancode) noexcept
	{
		switch (scancode)
		{
		case HID_INTL_HASH: return KEY_INTL_HASH;
		case HID_INTL_RO: return KEY_INTL_RO;
		case HID_INTL_YEN: return KEY_INTL_YEN;
	...
	[[nodiscard]] constexpr uint8_t soup_key_to_hid_scancode(uint8_t scancode) noexcept
	{
		switch (scancode)
		{
		case KEY_INTL_HASH: return HID_INTL_HASH;
		case KEY_INTL_RO: return HID_INTL_RO;
		case KEY_INTL_YEN: return HID_INTL_YEN;
